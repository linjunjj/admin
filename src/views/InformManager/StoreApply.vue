<template xmlns:v-popover="http://www.w3.org/1999/xhtml">
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="拼命加载中" :height="tableHeight" border stripe fit
      ...
      <el-table-column align="center" width="120px" label="名字" prop="id" sortable>
      </el-table-column>
      <el-table-column align="center" width="120px" label="银行账户" prop="id" sortable>
      </el-table-column>
      <el-table-column align="center" width="100px" label="营业执照">
        <template scope="scope">
          <img :src="scope.row.url" style="width: 64px;height: 64px;padding-top: 5px;"/>
        </template>
      </el-table-column>

      <el-table-column align="center" width="100px" label="法人身份证正面">
        <template scope="scope">
          <img :src="scope.row.url" style="width: 64px;height: 64px;padding-top: 5px;"/>
        </template>
      </el-table-column>
      <el-table-column align="center" width="100px" label="法人身份证反面">
        <template scope="scope">
          <img :src="scope.row.url" style="width: 64px;height: 64px;padding-top: 5px;"/>
        </template>
      </el-table-column>
      <el-table-column align="center" width="100px" label="手机号码" prop="stock" sortable>
      </el-table-column>


      <el-table-column align="center" label="状态" width="100">
        <template scope="scope">
          <el-tag :type="scope.row.status | statusFilter">{{scope.row.status ? '未通过' : '已通过'}}</el-tag>
        </template>
      </el-table-column>
