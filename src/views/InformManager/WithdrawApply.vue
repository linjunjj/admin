<template xmlns:v-popover="http://www.w3.org/1999/xhtml">
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="拼命加载中" :height="tableHeight" border stripe fit
      ...
      <el-table-column align="center" width="150px" label="申请时间" sortable>
          ...
          <el-popover
            ...
            <el-row style="margin-bottom: 3px;">
              <el-button v-if="scope.row.stutas === 1" size="small" type="warning"
                         @click="handleModifyStatus(scope.row, 2)">未通过
              </el-button>
            </el-row>
            <el-row style="margin-bottom: 3px;">
    ...
    methods: {
      judge(){
        ...
        if (info===0||info===1||info===2){
          if (temp== ''){
            ...
            this.getSearchWithDrawStatus(temp,info);
          }
      ...
      getSearchWithDraw(condition){
        ...
        setTimeout((items, total) => {
          ...
          info.page=this.listQuery.page;
          info.pagesize=this.listQuery.limit;
          this.$store.dispatch('GetSearchWithdrawApply',info).then((res)=>{
            this.total=res.total;
            this.list=res.list;
          })
          this.listLoading = false;
      ...
      getSearchWithDrawStatus(condition,status){
        this.listLoading = true;
        setTimeout((items, total) => {
          var info={};
          info.condition=condition;
          ...
          info.page=this.listQuery.page;
          info.pagesize=this.listQuery.limit;
          this.$store.dispatch('GetSearchWithdrawApplyStatus',info).then((res)=>{
            this.total=res.total;
            this.list=res.list;
          })
          this.listLoading = false;
